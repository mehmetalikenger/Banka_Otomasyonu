...
{
    public partial class TicariMSilPanel : Form
    {
        public TicariMSilPanel()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (comboSilTur.Text == "Vergi No")
                {
                    banka.VergiNoTMusteriSil(Convert.ToInt64(txtNo.Text));
                }
                else if (comboSilTur.Text == "Musteri No")
                {
                    banka.MusteriNoTMusteriSil(Convert.ToInt64(txtNo.Text));
                }
                else
                {
        ...
        private void TicariMSilPanel_Load(object sender, EventArgs e)
        {
