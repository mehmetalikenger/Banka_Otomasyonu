...
{
    public partial class Banka_Ticari_Hesap_Ozet : Form
    {
        public Banka_Ticari_Hesap_Ozet()
        {
            InitializeComponent();
        ...
        private void btnListele_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                banka.TicariHesapOzetleriGetir(txtBaslangicTarihi.Text, txtBitisTarihi.Text, long.Parse(txtHesapNo.Text), gridHesapOzet);
            }
            catch
            {
